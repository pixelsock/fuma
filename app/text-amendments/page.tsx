...
export default function TextAmendmentsPage() {
  ...
  const timelineItems = [
    ...
    },
    {
      ...
      description: 'Click the button below or <a href="https://publicinput.com/udo-comment-hub" target="_blank" rel="noopener noreferrer" class="text-primary hover:underline">click here</a> to submit a suggested update or recommended change.',
